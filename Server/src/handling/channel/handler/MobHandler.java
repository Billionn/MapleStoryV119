...
public class MobHandler {
    ...
    public static final void MoveMonster(final SeekableLittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        ...
        slea.skip(29); //extra 8 bytes or what
        /*if (!GameConstants.GMS && (monster.getId() == 8300006 || monster.getId() == 8300007)) { //dragon
            final int offset = slea.readInt();
            if (offset > 0) { //movement parse error
                //test more
